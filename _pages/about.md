...
I am currently a Ph.D. student (Integrated Master's-PhD Program) of the Institute of Intelligent Vehicles at [Tongji University](https://www.tongji.edu.cn/) under the supervision of Professor [Bingzhao Gao](https://auto.tongji.edu.cn/info/1165/7634.htm) with [College of Automotive and Energy Engineering](https://auto.tongji.edu.cn/) (former: School of Automotive Studies). I am a reviewer of several academic journals and conferences, such as Knowledge-Based Systems (KBS), IEEE ITSC, IEEE IV, etc.
...
- [ScenePilot-4K: A Large-Scale First-Person Dataset and Benchmark for Vision-Language Models in Autonomous Driving](https://arxiv.org/abs/2601.19582)<br>**Yujin Wang**, Yutong Zheng, Wenxian Fan, Tianyi Wang, Hongqing Chu, Li Zhang, Bingzhao Gao, Daxin Tian, Jianqiang Wang, Hong Chen<br>Preprint.
- [KEPT: Knowledge-Enhanced Prediction of Trajectories from Consecutive Driving Frames with Vision-Language Models](https://www.sciopen.com/article/10.26599/COMMTR.2026.9640012)<br>**Yujin Wang**, Tianyi Wang, Quanfeng Liu, Wenxian Fan, Junfeng Jiao, Christian Claudel, Yunbing Yan, Bingzhao Gao, Jianqiang Wang, Hong Chen<br>Communications in Transportation Research (Q1, IF: 14.5), 2026, 6(1): 9640012.
...
- [Rac3: Retrieval-augmented corner case comprehension for autonomous driving with vision-language models](https://ieeexplore.ieee.org/document/11433078)<br>**Yujin Wang**, Quanfeng Liu, Jiaqi Fan, Jinlong Hong, Hongqing Chu, Mengjian Tian, Bingzhao Gao, Hong Chen<br>IEEE Transactions on Multimedia (Q1, IF: 9.7), Early Access.
...
- [DCT-ISTA: A Network Block to Denoise Raw Vibration Signal with Interpretability for Mechanical Fault Diagnosis](https://ieeexplore.ieee.org/abstract/document/10633143)<br>Yujie Zhao, Shibin Wang, **Yujin Wang**, Zhi Cao<br>2024 IEEE International Conference on Mechatronics and Automation (ICMA)
- [Task Formalization for Autonomous Driving Turning at Roundabouts with Signal Temporal Logic Specifications](https://ieeexplore.ieee.org/abstract/document/10585549)<br>Yutong Zheng, **Yujin Wang**, Quanfeng Liu, Jinlong Hong, Qiankun Yu, Bingzhao Gao<br>2024 4th International Conference on Computer, Control and Robotics (ICCCR)
- [Decision-Making Based on Signal Temporal Logic for Ramp Merging and Diverging of Autonomous Vehicle](https://ieeexplore.ieee.org/abstract/document/10585550)<br>Quanfeng Liu, **Yujin Wang**, Yutong Zheng, Jinlong Hong, Meiping Yun, Bingzhao Gao<br>2024 4th International Conference on Computer, Control and Robotics (ICCCR)
